...
export class ChatState {
  ...
  get pendingProviderHandoff(): QueuedMessage | null {
    return this.state.pendingProviderHandoff;
  }

  set pendingProviderHandoff(value: QueuedMessage | null) {
    this.state.pendingProviderHandoff = value;
  }
