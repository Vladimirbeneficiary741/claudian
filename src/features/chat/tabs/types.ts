...
export interface TabData {
  ...
  /**
   * Provider explicitly chosen by the user via the model picker.
   * When set, automatic provider fallback should not silently move the tab
   * away from this provider unless the user explicitly confirms the switch.
   */
  manualProviderSelection: ProviderId | null;
